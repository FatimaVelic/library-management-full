...
Purpuse:        This is the starting point of the system.
*/
...
<head>
    ...
    <title>Little Library Management System | </title>
...
<p class="help-block"><a href="user-forgot-password.php">Forgot Password</a></p>
 ...
 <button type="submit" name="login" class="btn btn-info">LOGIN </button> | Not a member yet? <a href="signup.php">Register here</a>
</form>
 </div>
</div>
</div>
