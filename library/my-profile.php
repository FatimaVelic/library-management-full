...
Purpuse:        This page opens when user requests personal infomation.
*/
...
<head>
    ...
    <title>Little Library Management System | Student Signup</title>
...
<?php 
$sid=$_SESSION['stdid'];
$sql="SELECT StudentId,FullName,EmailId,MobileNumber,RegDate,LastUpdated,Status from  tblstudents  where StudentId=:sid ";
$query = $dbh -> prepare($sql);
$query-> bindParam(':sid', $sid, PDO::PARAM_STR);
$query->execute();
...
<?php if($result->LastUpdated!=""){?>
<div class="form-group">
<label>Last Updated Date : </label>
<?php echo htmlentities($result->LastUpdated);?>
</div>
<?php } ?>
